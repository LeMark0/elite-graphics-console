...
Placement clarification (2026-09-16, before implementation): The + button shares the All / VR / Flat filter row, aligned at its right edge. This follows the user's layout correction and keeps creation next to library navigation.
