...
2026-09-17 control refinement: replace the typographic plus with a geometrically centered vector and give all preset-filter controls the same height. Fully template menu items, popup borders, separators, checkboxes and dropdown options to remove native white/blue chrome. Keep keyboard focus visible and retain WPF menu/checkbox behavior.
